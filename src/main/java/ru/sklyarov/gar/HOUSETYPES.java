 ...
 *       &lt;sequence&gt;
 *         &lt;element name="HOUSETYPE" maxOccurs="unbounded"&gt;
 *           &lt;complexType&gt;
 *             &lt;complexContent&gt;
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
...
@XmlRootElement(name = "HOUSETYPES")
public class HOUSETYPES {

    @XmlElement(name = "HOUSETYPE", required = true)
    protected List<HOUSETYPES.HOUSETYPE> housetype;
     ...
     * This is why there is not a <CODE>set</CODE> method for the housetype property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHOUSETYPE().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link HOUSETYPES.HOUSETYPE }
     * 
     * 
     */
    public List<HOUSETYPES.HOUSETYPE> getHOUSETYPE() {
        if (housetype == null) {
            housetype = new ArrayList<HOUSETYPES.HOUSETYPE>();
        }
